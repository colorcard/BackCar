...
void mpu6050_get_gyro (void)
{
    ...
    mpu6050_gyro_z = (int16)(((uint16)dat[4] << 8 | dat[5]))-4;//强行校准归零
    //添加角速度死区
    if(mpu6050_gyro_z>=-1&&mpu6050_gyro_z<=2){mpu6050_gyro_z=0;}
//    if(mpu6050_gyro_y>=30&&mpu6050_gyro_y<=33){mpu6050_gyro_y=32;}
//    if(mpu6050_gyro_x<=-20&&mpu6050_gyro_z>=-22){mpu6050_gyro_x=21;}
